...
// 4. DESSIN D'OBJETS
// ##################
	// Affiche une image (dans le fichier nomfic) de taille (w,h) au point bg (point inférieur gauche de l'image)
	void affiche_image(char *nomfic, POINT bg, int w, int h);
	// Affiche dans la fenêtre au point bg_fen un morceau de l'image de taille (w_morceau,h_morceau) 
	// dont le point inférieur gauche est bg_morceau
